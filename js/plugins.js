  ...
  (function (e) {
    ...
    function t(t) {
      ...
      if (
        ...
        (c = 0 === p ? d : p),
        'deltaY' in r && ((p = -1 * r.deltaY), (c = p)),
        'deltaX' in r && ((d = r.deltaX), 0 === p && (c = -1 * d)),
        0 !== p || 0 !== d)
      ) {
        if (1 === r.deltaMode) {
        ...
        return (
          (t.deltaX = d), (t.deltaY = p), (t.deltaFactor = s), (t.offsetX = h), (t.offsetY = v), (t.deltaMode = 0), a.unshift(t, c, d, p), o && clearTimeout(o), (o = setTimeout(i, 200)), (e.event.dispatch || e.event.handle).apply(this, a)
        );
      }
    }
    function i() {
      ...
      function i(t, i) {
        function n(i) {
          ...
          if (((I = i), void 0 === L))
            (d = t.scrollTop()),
              ...
              (q = t.innerHeight()),
              t.width(O),
              (L = e('<div class="jspPane" />').css('padding', ge).append(t.children())),
            ...
            if (
              ...
              u && ((O = t.innerWidth() + me), (q = t.innerHeight()), F.css({ width: O + 'px', height: q + 'px' })),
          ...
          L.css('overflow', 'auto'),
            ...
            K || $
              ...
              : (t.removeClass('jspScrollable'), L.css({ top: 0, left: 0, width: F.width() - me }), H(), P(), X(), f()),
          ...
          $ &&
            (F.append(
              e('<div class="jspVerticalBar" />').append(
                ...
                e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragTop" />'), e('<div class="jspDragBottom" />'))),
            ...
            (U = ne.find('>.jspDrag')),
            I.showArrows &&
              ((ae = e('<a class="jspArrow jspArrowUp" />').bind('mousedown.jsp', u(0, -1)).bind('click.jsp', M)),
              (le = e('<a class="jspArrow jspArrowDown" />').bind('mousedown.jsp', u(0, 1)).bind('click.jsp', M)),
              I.arrowScrollOnHover && (ae.bind('mouseover.jsp', u(0, -1, ae)), le.bind('mouseover.jsp', u(0, 1, le))),
          ...
          K &&
            (F.append(
              e('<div class="jspHorizontalBar" />').append(
                ...
                e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragLeft" />'), e('<div class="jspDragRight" />'))),
            ...
            (J = ue.find('>.jspDrag')),
            I.showArrows &&
              ((fe = e('<a class="jspArrow jspArrowLeft" />').bind('mousedown.jsp', u(-1, 0)).bind('click.jsp', M)),
              (he = e('<a class="jspArrow jspArrowRight" />').bind('mousedown.jsp', u(1, 0)).bind('click.jsp', M)),
              I.arrowScrollOnHover && (fe.bind('mouseover.jsp', u(-1, 0, fe)), he.bind('mouseover.jsp', u(1, 0, he))),
        ...
        function l() {
          ...
          K && L.width(F.outerWidth() - me + 'px'),
            (V = L.outerHeight()),
            (Q = V / q),
            K && ((pe = Math.ceil((1 / G) * de)), pe > I.horizontalDragMaxWidth ? (pe = I.horizontalDragMaxWidth) : pe < I.horizontalDragMinWidth && (pe = I.horizontalDragMinWidth), J.width(pe + 'px'), (ee = de - pe), j(te)),
            $ && ((re = Math.ceil((1 / Q) * se)), re > I.verticalDragMaxHeight ? (re = I.verticalDragMaxHeight) : re < I.verticalDragMinHeight && (re = I.verticalDragMinHeight), U.height(re + 'px'), (Z = se - re), g(_));
        }
        function c(e, t, i, n) {
          var o,
            s = 'before',
        ...
        function x(t, i, n) {
          ...
          (a = T()),
            (c = a + q),
            a > f || i ? (d = f - I.horizontalGutter) : f + s > c && (d = f - q + s + I.horizontalGutter),
            isNaN(d) || k(d, n),
            (l = D()),
            (u = l + O),
            l > h || i ? (p = h - I.horizontalGutter) : h + r > u && (p = h - O + r + I.horizontalGutter),
            isNaN(p) || y(p, n);
        }
        function D() {
            ...
            e(document.body).delegate('a[href*="#"]', 'click', function (t) {
              ...
              if ((-1 !== location.href.indexOf('#') && (c = location.href.substr(0, location.href.indexOf('#'))), l === c)) {
                ...
                n.length &&
                  ...
                  o[0].scrollIntoView && ((r = e(window).scrollTop()), (a = n.offset().top), (r > a || a > r + e(window).height()) && o[0].scrollIntoView()),
                  t.preventDefault());
              }
            }));
        }
        ...
        'border-box' === t.css('box-sizing')
          ? ((ge = 0), (me = 0))
          : ((ge = t.css('paddingTop') + ' ' + t.css('paddingRight') + ' ' + t.css('paddingBottom') + ' ' + t.css('paddingLeft')), (me = (parseInt(t.css('paddingLeft'), 10) || 0) + (parseInt(t.css('paddingRight'), 10) || 0))),
          e.extend(be, {
