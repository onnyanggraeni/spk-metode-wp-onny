...
(function () {
      ...
      if (f) {
        ...
        h[q]
          ...
          : ((g.id = a = 'highcharts-' + yb++),
            (h[q] = i = d.createElement(f).attr(g).add(d.defs)),
            (i.stops = []),
            m(j, function (a) {
        ...
        if (f.namespaceURI === Ca || c.forExport) {
          try {
            (k =
              ...
              (b = f.getBBox ? r({}, f.getBBox()) : { width: f.offsetWidth, height: f.offsetHeight }),
  ...
  K.prototype.translateXSetter =
    K.prototype.translateYSetter =
    K.prototype.rotationSetter =
    K.prototype.verticalAlignSetter =
    K.prototype.scaleXSetter =
    K.prototype.scaleYSetter =
      function (a, b) {
        this[b] = a;
        this.doTransform = !0;
      };
            ...
            m(g, function (e) {
              if (e !== '' || g.length === 1) {
                ...
                if (e !== ' ') {
                  ...
                  if (l) {
                    for (
                      var o = e.replace(/([^\^])-/g, '$1- ').split(' '), m = g.length > 1 || f || (o.length > 1 && k.whiteSpace !== 'nowrap'), S, s, ua, u = [], t = C(y), x = 1, r = a.rotation, z = e, w = z.length;
                      ...
                      (a.rotation = 0),
                        ...
                        s === void 0 && (s = S),
                        q && s
                          ? ((w /= 2), z === '' || (!S && w < 0.5) ? (o = []) : (S && (s = !0), (z = e.substring(0, z.length + (S ? -1 : 1) * sa(w))), (o = [z + '…']), y.removeChild(y.firstChild)))
                          : !S || o.length === 1
                          ? ((o = u), (u = []), o.length && (x++, (y = A.createElementNS(Ca, 'tspan')), L(y, { dy: t, x: j }), p && L(y, 'style', p), b.appendChild(y)), ua > l && (l = ua))
  ...
  va.prototype = {
    ...
    setTickInterval: function (a) {
      ...
      h
        ? ((b.linkedParent = c[b.coll][d.linkedTo]), (c = b.linkedParent.getExtremes()), (b.min = p(c.min, c.dataMin)), (b.max = p(c.max, c.dataMax)), d.type !== b.linkedParent.options.type && ka(11, 1))
    ...
    unsquish: function () {
      ...
      c
        ? (l = s(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) &&
          m(l, function (a) {
            var b;
    ...
    renderUnsquish: function () {
      ...
      if (this.autoRotation)
        ...
        for (h = c.length; !f && h--; )
          if (((i = c[h]), (i = d[i].label))) if ((i.styles.textOverflow === 'ellipsis' && i.css({ textOverflow: 'clip' }), i.getBBox().height > this.len / c.length - (g.h - g.f))) i.specCss = { textOverflow: 'ellipsis' };
      }
    ...
    drawCrosshair: function (a, b) {
      ...
      if (!this.crosshair || (s(b) || !p(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
        ...
        (p(d.snap, !0) ? s(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : (c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos),
    ...
    refresh: function (a, b) {
      ...
      i === !1
        ...
        : (this.isHidden && (db(d), d.attr('opacity', 1).show()),
          ...
          d.attr({ stroke: k }),
          this.updatePosition({ plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow, h: (a.shapeArgs && a.shapeArgs.height) || 0 }),
          (this.isHidden = !1));
    ...
    onContainerClick: function (a) {
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, 'highcharts-tracker')
          ? (M(c.series, 'click', r(a, { point: c })), b.hoverPoint && c.firePointEvent('click', a))
          : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && M(b, 'click', a)));
    },
  ...
  mb.prototype = {
    ...
    renderItem: function (a) {
      ...
      if (!m) {
        ...
        a.legendItem = m = c
          .text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, r)
          .css(z(a.visible ? h : i))
    ...
    adjustMargins: function (a, b) {
      ...
      this.display &&
        !d.floating &&
        m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
        ...
        if (i) {
          ...
          (a.box = i =
            c
              ...
              .attr({ stroke: j.borderColor, 'stroke-width': l || 0, fill: n || R })
              .add(d)
              .shadow(j.shadow)),
            (i.isNew = !0);
        i[f ? 'show' : 'hide']();
  ...
  D.prototype = {
    ...
    drawChartBox: function () {
      ...
      if (n) g ? g.animate(g.crisp({ x: q, y: p, width: m, height: s, strokeWidth: -n })) : (this.plotBorder = b.rect(q, p, m, s, 0, -n).attr({ stroke: a.plotBorderColor, 'stroke-width': n, fill: R, zIndex: 1 }).add());
      this.isDirtyBox = !1;
    },
    ...
    isReadyToRender: function () {
      var a = this;
      return (!ba && H == H.top && A.readyState !== 'complete') || (ea && !H.canvg)
        ? (ea
            ? Lb.push(function () {
                a.firstRender();
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
        ...
        if (o && h > o) {
          ...
          if (qa(k)) {
            ...
            if (s) for (c = 0; c < h; c++) (i = a[c]), (q[c] = i[0]), (y[c] = i.slice(1, s + 1));
      ...
      function a(b, d, g) {
        ...
        if ((i = b && b.length))
          return (
            ...
            (i = Math.floor(i / 2)),
            { point: b[i], left: a(b.slice(0, i), d + 1, g), right: a(b.slice(i + 1), d + 1, g) }
          );
      }
      function b() {
  ...
  r(D.prototype, {
    ...
    showLoading: function (a) {
      ...
      if (!d) (b.loadingDiv = d = Z(Ka, { className: 'highcharts-loading' }, r(e.style, { zIndex: 10, display: R }), b.container)), (b.loadingSpan = Z('span', null, e.labelStyle, d)), N(b, 'redraw', f);
      ...
      m(d, function (d) {
        ...
        g
          ...
          : (a[f] = a.chart.renderer
              .path(b)
              .attr({ fill: p(d[2], na(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()), zIndex: 0 })
              .add(a.group));
      });
    },
  ...
  xa = ja(Q, {
    ...
    animate: function (a) {
      ...
      if (ba)
        a
          ? ((e.scaleY = 0.001), (a = I(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))), d ? (e.translateX = a - b.len) : (e.translateY = a), this.group.attr(e))
      ...
      setVisible: function (a, b) {
        ...
        if (a !== c.visible || b)
          if (
            ...
            c.legendItem && (e.hasRendered && (d.updateTotals(), e.legend.clearItems(), f || e.legend.render()), e.legend.colorizeItem(c, a)),
            f)
          )
  ...
  Q.prototype.alignDataLabel = function (a, b, c, d, e) {
    ...
    if (l)
      (d = r({ x: g ? f.plotWidth - i : h, y: x(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
        ...
        c.rotation
          ...
          : (b.align(c, null, d),
            (g = b.alignAttr),
            p(c.overflow, 'justify') === 'justify' ? this.justifyDataLabel(b, c, g, j, d, e) : p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)),
                  ...
                  (D = u._attr.visibility),
                    ...
                    j
                      ...
                      : (b.connector = j =
                          a.chart.renderer
                            .path(k)
                            .attr({ 'stroke-width': g, stroke: e.connectorColor || b.color || '#606060', visibility: D })
        ...
        for (c = d + 1; c < b; ++c)
          if (
            ...
            i &&
              ...
              i.newOpacity !== 0 &&
              j.newOpacity !== 0 &&
              !(j.alignAttr.x > i.alignAttr.x + i.width || j.alignAttr.x + j.width < i.alignAttr.x || j.alignAttr.y > i.alignAttr.y + i.height || j.alignAttr.y + j.height < i.alignAttr.y))
          )
  ...
  T = w.TrackerMixin = {
    ...
    drawTrackerGraph: function () {
      ...
      j
        ...
        : ((a.tracker = h
            .path(d)
            .attr({ 'stroke-linejoin': 'round', visibility: a.visible ? 'visible' : 'hidden', stroke: p, fill: c ? p : R, 'stroke-width': b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 })
            .add(a.group)),
  ...
  r(Ga.prototype, {
    ...
    setState: function (a, b) {
      ...
      if (!((a === this.state && !b) || (this.selected && a !== 'select') || (f[a] && f[a].enabled === !1) || (a && (j || (h && i.enabled === !1))) || (a && l.states && l.states[a] && l.states[a].enabled === !1))) {
        if (this.graphic) (g = g && this.graphic.symbolName && p.r), this.graphic.attr(z(p, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})), k && k.hide();
        else {
          if (a && i)
