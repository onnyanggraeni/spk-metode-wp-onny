  ...
  (t.cleanData = function (e) {
    ...
    (t.widget = function (i, s, n) {
      ...
      (i = i.split('.')[1]),
        ...
        (r.prototype = t.widget.extend(h, { widgetEventPrefix: a ? h.widgetEventPrefix : i }, l, { constructor: r, namespace: c, widgetName: i, widgetFullName: o })),
        a
    ...
    _setContainment: function () {
      ...
      return n.containment
        ? 'window' === n.containment
          ...
          ? ((this.containment = [0, 0, t(document).width() - this.helperProportions.width - this.margins.left, (t(document).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]), undefined)
    ...
    _generatePosition: function (e) {
      ...
      return (
        ...
        this.originalPosition &&
          (this.containment &&
            (this.relative_container ? ((s = this.relative_container.offset()), (i = [this.containment[0] + s.left, this.containment[1] + s.top, this.containment[2] + s.left, this.containment[3] + s.top])) : (i = this.containment),
  ...
  t.widget('ui.resizable', t.ui.mouse, {
    ...
    _create: function () {
      ...
      if (
        ...
        t.extend(this, { _aspectRatio: !!r.aspectRatio, aspectRatio: r.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: r.helper || r.ghost || r.animate ? r.helper || 'ui-resizable-helper' : null }),
      ...
      resize: function () {
        ...
        (i.grid = r),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : ((e.size.width = d), (e.size.height = p), (e.position.top = a.top - u), (e.position.left = a.left - c));
      },
    });
})(jQuery);
(function (t) {
              ...
              h
                ...
                : (i.selecting &&
                    ((e.metaKey || e.ctrlKey) && i.startselected
                      ...
                      : (i.$element.removeClass('ui-selecting'), (i.selecting = !1), i.startselected && (i.$element.addClass('ui-unselecting'), (i.unselecting = !0)), s._trigger('unselecting', e, { unselecting: i.element }))),
                  i.selected &&
                    (e.metaKey ||
                      e.ctrlKey ||
                      i.startselected ||
          ...
          i.length && a.length
            ...
            : i.length &&
              this.headers
                ...
                .attr('tabIndex', -1),
          i.attr({ 'aria-expanded': 'true', 'aria-hidden': 'false' }).prev().attr({ 'aria-selected': 'true', tabIndex: 0 });
      },
  ...
  e.widget('ui.button', {
    ...
    _resetButton: function () {
      ...
      n.primary || n.secondary
        ? (this.options.text && a.push('ui-button-text-icon' + (s ? 's' : n.primary ? '-primary' : '-secondary')),
          ...
          this.options.text || (a.push(s ? 'ui-button-icons-only' : 'ui-button-icon-only'), this.hasTitle || t.attr('title', e.trim(i))))
      ...
      return 2 === arguments.length && 'string' == typeof a
        ...
        : ((r = a || {}),
          ...
          l &&
            ...
            (u = this._getMinMaxDate(l, 'min')),
            (c = this._getMinMaxDate(l, 'max')),
            s(l.settings, r),
            null !== u && r.dateFormat !== t && r.minDate === t && (l.settings.minDate = this._formatDate(l, u)),
            null !== c && r.dateFormat !== t && r.maxDate === t && (l.settings.maxDate = this._formatDate(l, c)),
        ...
        for (w = '', this.maxRows = 4, M = 0; q[1] > M; M++) {
          ...
          for (
            I += N + '</tr></thead><tbody>',
              ...
              E = (this._getFirstDayOfMonth(et, Z) - l + 7) % 7,
              S = Math.ceil((E + A) / 7),
            ...
            for (I += '<tr>', O = h ? "<td class='ui-datepicker-week-col'>" + this._get(e, 'calculateWeek')(F) + '</td>' : '', y = 0; 7 > y; y++)
              (j = f ? f.apply(e.input ? e.input[0] : null, [F]) : [!0, '']),
                ...
                (O +=
                  "<td class='" +
                  ((y + l + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : '') +
        ...
        this._on({
          ...
          'click .ui-menu-item:has(a)': function (e) {
            ...
            !this.mouseHandled &&
              ...
              ((this.mouseHandled = !0),
              this.select(e),
              i.has('.ui-menu').length ? this.expand(e) : this.element.is(':focus') || (this.element.trigger('focus', [!0]), this.active && 1 === this.active.parents('.ui-menu').length && clearTimeout(this.timer)));
          },
        ...
        : ((this.elementSize = { width: this.element.outerWidth(), height: this.element.outerHeight() }),
          ...
          r === !1
            ...
            : ((this._mouseSliding = !0),
              ...
              (this._clickOffset = h
                ? { left: 0, top: 0 }
                : { left: e.pageX - l.left - a.width() / 2, top: e.pageY - l.top - a.height() / 2 - (parseInt(a.css('borderTopWidth'), 10) || 0) - (parseInt(a.css('borderBottomWidth'), 10) || 0) + (parseInt(a.css('marginTop'), 10) || 0) }),
    ...
    _slide: function (t, e, i) {
      ...
      this.options.values && this.options.values.length
        ? ((s = this.values(e ? 0 : 1)),
          ...
          i !== this.values(e) && ((n = this.values()), (n[e] = i), (a = this._trigger('slide', t, { handle: this.handles[e], value: i, values: n })), (s = this.values(e ? 0 : 1)), a !== !1 && this.values(e, i, !0)))
  ...
  t.effects.effect.transfer = function (e, i) {
    var s = t(this),
      ...
      u = t("<div class='ui-effects-transfer'></div>")
        ...
        .css({ top: d.top - r, left: d.left - l, height: s.innerHeight(), width: s.innerWidth(), position: a ? 'fixed' : 'absolute' })
