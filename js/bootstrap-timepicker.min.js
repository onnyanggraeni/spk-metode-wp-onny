  ...
  (h.prototype = {
    ...
    _init: function () {
      ...
      this.$element.parent().hasClass('input-append') || this.$element.parent().hasClass('input-prepend')
        ...
        : this.template
        ? this.$element.on({ 'focus.timepicker': t.proxy(this.showWidget, this), 'click.timepicker': t.proxy(this.showWidget, this), 'blur.timepicker': t.proxy(this.blurElement, this) })
        : this.$element.on({
            'focus.timepicker': t.proxy(this.highlightUnit, this),
            'click.timepicker': t.proxy(this.highlightUnit, this),
            'keydown.timepicker': t.proxy(this.elementKeydown, this),
    ...
    getTemplate: function () {
      ...
      switch (
        (this.showInputs
          ? ((i = '<input type="text" name="hour" class="bootstrap-timepicker-hour" maxlength="2"/>'),
            (e = '<input type="text" name="minute" class="bootstrap-timepicker-minute" maxlength="2"/>'),
            (s = '<input type="text" name="second" class="bootstrap-timepicker-second" maxlength="2"/>'),
            (h = '<input type="text" name="meridian" class="bootstrap-timepicker-meridian" maxlength="2"/>'))
          : ((i = '<span class="bootstrap-timepicker-hour"></span>'),
            ...
            (h = '<span class="bootstrap-timepicker-meridian"></span>')),
        (n =
          ...
          (this.showMeridian ? '<td class="separator">&nbsp;</td><td>' + h + '</td>' : '') +
          '</tr>' +
          '<tr>' +
    ...
    hideWidget: function () {
      this.isOpen !== !1 &&
        ...
        t(e).off('mousedown.timepicker'),
        (this.isOpen = !1));
    },
    highlightUnit: function () {
      (this.position = this.getCursorPosition()),
        this.position >= 0 && 2 >= this.position
          ? this.highlightHour()
          : this.position >= 3 && 5 >= this.position
          ? this.highlightMinute()
          : this.position >= 6 && 8 >= this.position
          ? this.showSeconds
            ? this.highlightSecond()
            : this.highlightMeridian()
          : this.position >= 9 && 11 >= this.position && this.highlightMeridian();
    },
    ...
    setTime: function (t) {
      ...
      this.showMeridian ? ((i = t.split(' ')), (e = i[0].split(':')), (this.meridian = i[1])) : (e = t.split(':')),
        ...
        this.showMeridian
          ? (this.hour > 12 ? (this.hour = 12) : 1 > this.hour && (this.hour = 12),
            'am' === this.meridian || 'a' === this.meridian ? (this.meridian = 'AM') : ('pm' === this.meridian || 'p' === this.meridian) && (this.meridian = 'PM'),
            'AM' !== this.meridian && 'PM' !== this.meridian && (this.meridian = 'AM'))
          : this.hour >= 24
          ? (this.hour = 23)
          : 0 > this.hour && (this.hour = 0),
      ...
      if (this.$widget !== !1) {
        ...
        this.showInputs
          ? (this.$widget.find('input.bootstrap-timepicker-hour').val(t),
            ...
            this.showSeconds && this.$widget.find('input.bootstrap-timepicker-second').val(e),
          ...
          : (this.$widget.find('span.bootstrap-timepicker-hour').text(t),
            ...
            this.showSeconds && this.$widget.find('span.bootstrap-timepicker-second').text(e),
    ...
    updateFromWidgetInputs: function () {
      if (this.$widget !== !1) {
        var i =
          t('input.bootstrap-timepicker-hour', this.$widget).val() +
          ':' +
          t('input.bootstrap-timepicker-minute', this.$widget).val() +
          (this.showSeconds ? ':' + t('input.bootstrap-timepicker-second', this.$widget).val() : '') +
          (this.showMeridian ? ' ' + t('input.bootstrap-timepicker-meridian', this.$widget).val() : '');
        this.setTime(i);
      }
    },
