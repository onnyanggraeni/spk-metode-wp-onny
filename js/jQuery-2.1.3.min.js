...
!(function (a, b) {
  ...
  function tb(a) {
    ...
    return (
      c ||
        ((c = sb(a, b)), ('none' !== c && c) || ((qb = (qb || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)), (b = qb[0].contentDocument), b.write(), b.close(), (c = sb(a, b)), qb.detach()), (rb[a] = c)),
      c
    );
  }
  var ub = /^margin/,
  ...
  function Vb(a, b, c) {
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        ((c.overflow = [o.overflow, o.overflowX, o.overflowY]), (j = n.css(a, 'display')), (k = 'none' === j ? L.get(a, 'olddisplay') || tb(a.nodeName) : j), 'inline' === k && 'none' === n.css(a, 'float') && (o.display = 'inline-block')),
      c.overflow &&
        ((o.overflow = 'hidden'),
        l.always(function () {
              ...
              (b = function (a) {
                return function () {
                  b &&
                    ...
                    'abort' === a ? f.abort() : 'error' === a ? d(f.status, f.statusText) : d(Dc[f.status] || f.status, f.statusText, 'string' == typeof f.responseText ? { text: f.responseText } : void 0, f.getAllResponseHeaders()));
                };
              }),
                (f.onload = b()),
                (f.onerror = b('error')),
  ...
  (n.offset = {
    ...
    n.fn.extend({
      offset: function (a) {
        ...
        if (f)
          return (
            (b = f.documentElement), n.contains(b, d) ? (typeof d.getBoundingClientRect !== U && (e = d.getBoundingClientRect()), (c = Jc(f)), { top: e.top + c.pageYOffset - b.clientTop, left: e.left + c.pageXOffset - b.clientLeft }) : e
          );
      },
      position: function () {
        if (this[0]) {
