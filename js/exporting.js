...
(function (f) {
  ...
  q(z.prototype, {
    ...
    contextMenu: function (b, a, e, c, g, f, h) {
      ...
      if (!i)
        (d[k] = i = j('div', { className: b }, { position: 'absolute', zIndex: 1e3, padding: t + 'px' }, d.container)),
          (v = j('div', null, q({ MozBoxShadow: '3px 3px 10px #888', WebkitBoxShadow: '3px 3px 10px #888', boxShadow: '3px 3px 10px #888' }, l.menuStyle), i)),
          (w = function () {
            u(i, { display: 'none' });
            h && h.setState(0);
            d.openMenu = !1;
