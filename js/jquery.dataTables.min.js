...
(function (Fa, T, k) {
  var S = function (h) {
    ...
    function pb(a) {
      var b = a.oClasses,
        ...
        f = function () {
          ...
          b != e.sSearch && (ha(a, { sSearch: b, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }), (a._iDisplayStart = 0), M(a));
        },
    ...
    function ob(a) {
      for (
        var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h('<select/>', { name: c + '_length', 'aria-controls': c, class: b.sLengthSelect }), g = 0, i = f.length;
        g < i;
        g++
      )
    ...
    m = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase()) J(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
          ...
          j = o.oClasses;
          e.bJQueryUI
            ? (h.extend(j, m.ext.oJUIClasses, e.oClasses), e.sDom === l.sDom && 'lfrtip' === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer)
