  ...
  ($.AdminLTE.layout = {
    ...
    fixSidebar: function () {
      return $('body').hasClass('fixed')
        ? ('undefined' == typeof $.fn.slimScroll && console && console.error('Error: the fixed layout requires the slimscroll plugin!'),
          void (
      ...
      $(a).click(function (a) {
        a.preventDefault(),
          $(window).width() > b.sm - 1
            ...
            ? ($('body').removeClass('sidebar-open'), $('body').removeClass('sidebar-collapse'))
...
($.AdminLTE = {}),
  ($.AdminLTE.options = {
    ...
    enableFastclick: !0,
    enableBoxWidget: !0,
    boxWidgetOptions: { boxWidgetIcons: { collapse: 'fa fa-minus', open: 'fa fa-plus', remove: 'fa fa-times' }, boxWidgetSelectors: { remove: '[data-widget="remove"]', collapse: '[data-widget="collapse"]' } },
