	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			...
			<li><a href="kriteria.php" class="btn btn-warning">DATA KRITERIA</a></li>
			<li><a href="menu.php" class="btn btn-warning">DATA MENU</a></li>
			<li><a href="nilai.php" class="btn btn-warning">DATA NILAI</a></li>
			<li><a href="rangking.php" class="btn btn-warning">DATA RANGKING</a></li>
			<li><a href="bobot.php" class="btn btn-warning">DATA BOBOT</a></li>
			<li><a href="laporan.php" class="btn btn-warning">LAPORAN</a></li>
		  </ul>
...
?>
	...
	<div>
	  ...
	  <div class="tab-content">
		...
		?>
		            <tr>
		                <th><?php echo $row1x['nama_menu'] ?></th>
		                <?php
		                $ax= $row1x['id_menu'];
						$stmtrx = $pro->readR($ax);
		...
		?>
	    	...
	    	<h4>Perangkingan Metode WP <br>RM & CAFE PESONA PANDANG </br></h4>
			<table width="100%" class="table table-striped table-bordered">
		        <thead>
		            <tr>
		                <th rowspan="2" style="vertical-align: middle" class="text-center">Menu</th>
	...
	<footer class="text-center">&copy; 2022 RM & CAFE PESONA PANDANG</footer>
	</div>
